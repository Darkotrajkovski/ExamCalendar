...
import 'package:ExamCalendar/models/eventDTO.dart';
...
class DatabaseHelper {
  ...
  Future<List<EventModel>> getExamList() async {
    var taskMapList = await getExams();
  ...
  Future<int> addExam(EventModel eventModel) async {
  ...
  Future<int> updateExam(EventModel eventModel) async {
    EventDTO eventDTO = EventDTO();
